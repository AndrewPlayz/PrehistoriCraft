...
public class PhCWorldGen implements IWorldGenerator {
    ...
    private void generateSurface(World world, Random random, int x, int z) {
        ...
        this.addOreSpawn(PhCBlocks.block_aluminium_ore_block, world, random, x, z, 16, 16, 3 + random.nextInt(6), 25, 1, 63);
        this.addOreSpawn(PhCBlocks.block_chronosite_ore_block, world, random, x, z, 16, 16, 2 + random.nextInt(4), 10, 1, 24);
