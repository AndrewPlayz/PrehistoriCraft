...
public class ModelPachyrhinosaurusCanadensis extends AdvancedModelBase{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float rotation, float rotationYaw, float rotationPitch, float partialTicks, Entity entity) {
        ...
        walk(Head2, 0.1F, 0.0F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        ...
        //Body
        walk(Bodyfront, 0.1F, 0.001F * globalHeight, true, 3.0F, 0.0F, entity.ticksExisted, 1);
        walk(Bodyback, 0.1F, 0.001F * globalHeight, true, 3.0F, 0.0F, entity.ticksExisted, 1);

        //Tail
        swing(Tail1, 0.08F * globalSpeed, 0.05F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        swing(Tail2, 0.08F * globalSpeed, 0.15F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        swing(Tail3, 0.08F * globalSpeed, 0.25F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        swing(Tail4, 0.08F * globalSpeed, 0.35F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);


        //Walking Animations
        //Head
        walk(Head1, 0.1F * globalSpeed, 0.0F * globalHeight, true, 0.0F, 0.0F, limbSwing, limbSwingAmount);
        walk(Head2, 0.1F * globalSpeed, 0.0F * globalHeight, true, 0.0F, 0.0F, limbSwing, limbSwingAmount);
        walk(Lowerjaw, 0.1F * globalSpeed, 0.0F * globalHeight, true, 0.0F, -0.15F, limbSwing, limbSwingAmount);
        walk(Snout, 0.1F * globalSpeed, 0.0F * globalHeight, true, 0.0F, -0.15F, limbSwing, limbSwingAmount);

        //Neck
        walk(Neck1, 0.1F * globalSpeed, 0.03F * globalHeight, true, 3.0F, 0.0F, limbSwing, limbSwingAmount);
        walk(Neck2, 0.1F * globalSpeed, 0.03F * globalHeight, true, 3.0F, 0.0F, limbSwing, limbSwingAmount);
    }
}
