...
public class ModelDaspletosaurus extends AdvancedModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float rotation, float rotationYaw, float rotationPitch, float partialTicks, Entity entity) {
        ...
        walk(Snout, 0.1F, 0.0F * globalHeight, true, 0.0F, -0.15F, entity.ticksExisted, 1);
        ...
        swing(Tail3, 0.05F, 0.05F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        swing(Tail4, 0.05F, 0.05F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        swing(Tail5, 0.05F, 0.05F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        swing(Tail6, 0.05F, 0.05F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        ...
        flap(Upperarmleft, 0.1F, 0.04F * globalHeight, false, 0.5F, 0.0F, entity.ticksExisted, 1);
        flap(Lowerarmleft, 0.1F, 0.04F * globalHeight, false, 0.5F, 0.0F, entity.ticksExisted, 1);
        ...
        //Walking Animations
        //Body
        bob(Bodymain, 0.8F * globalSpeed, 0.6F * globalHeight, false, limbSwing, limbSwingAmount);
        bob(Bodyfront, 0.8F * globalSpeed, 0.6F * globalHeight, false, limbSwing, limbSwingAmount);

        //Right Leg
        walk(Thighright, 0.4F * globalSpeed, 0.5F * globalHeight, false, 0.0F, -0.1F, limbSwing, limbSwingAmount);
        walk(Upperlegbackleft, 0.4F * globalSpeed, 0.5F * globalHeight, false, -1.5F, 0.2F, limbSwing, limbSwingAmount);
        walk(Upperlegfrontleft, 0.4F * globalSpeed, 0.5F * globalHeight, false, -1.5F, 0.2F, limbSwing, limbSwingAmount);
        walk(Soleright, 0.4F * globalSpeed, 0.5F * globalHeight, true, -4.0F, -0.05F, limbSwing, limbSwingAmount);

        //Left Leg
        walk(Thightleft, 0.4F * globalSpeed, 0.5F * globalHeight, true, 0.0F, 0.2F, limbSwing, limbSwingAmount);
        walk(Upperlegbackright, 0.4F * globalSpeed, 0.5F * globalHeight, true, -1.5F, 0.2F, limbSwing, limbSwingAmount);
        walk(Upperlegfrontright, 0.4F * globalSpeed, 0.5F * globalHeight, true, -1.5F, 0.2F, limbSwing, limbSwingAmount);
        walk(Soleleft, 0.4F * globalSpeed, 0.5F * globalHeight, true, -8.0F, 0.1F, limbSwing, limbSwingAmount);
        ...
        //Tail
        swing(Tail1, 0.05F, 0.1F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        swing(Tail2, 0.05F, 0.1F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        swing(Tail3, 0.05F, 0.05F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        swing(Tail4, 0.05F, 0.05F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        swing(Tail5, 0.05F, 0.05F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
        swing(Tail6, 0.05F, 0.05F * globalHeight, true, 0.0F, 0.0F, entity.ticksExisted, 1);
