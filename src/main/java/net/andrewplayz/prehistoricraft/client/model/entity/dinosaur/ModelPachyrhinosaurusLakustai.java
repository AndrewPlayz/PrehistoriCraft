...
public class ModelPachyrhinosaurusLakustai extends AdvancedModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float rotation, float rotationYaw, float rotationPitch, float partialTicks, Entity entity) {
        ...
        walk(Lheelfoot, 0.3F * globalSpeed, 0.4F * globalHeight, false, -1.5F, 0.8F, limbSwing, limbSwingAmount);
        ...
        walk(Rheelfoot, 0.3F * globalSpeed, 0.4F * globalHeight, true, -1.5F, -0.5F, limbSwing, limbSwingAmount);
