package net.andrewplayz.prehistoricraft.client.model.ornithomimus;

import net.ilexiconn.llibrary.client.model.modelbase.MowzieModelBase;
import net.ilexiconn.llibrary.client.model.modelbase.MowzieModelRenderer;
import net.minecraft.entity.Entity;

public class OrnithomimusFemale extends MowzieModelBase{
    ...
    public MowzieModelRenderer Rupperleg;
    ...
    public MowzieModelRenderer Rtoemiddle2;
    ...
    public MowzieModelRenderer Lupperleg;
    ...
    public MowzieModelRenderer Rarmfeathers1;
    public MowzieModelRenderer Rhand;
    public MowzieModelRenderer Rarmfeather2;
    public MowzieModelRenderer Rfinger2;
    public MowzieModelRenderer Rfinger1;
    public MowzieModelRenderer Rfinger3;
    public MowzieModelRenderer Lupperarm;
    public MowzieModelRenderer Llowerarm;
    public MowzieModelRenderer Larmfeather1;
    public MowzieModelRenderer Lhand;
    public MowzieModelRenderer Larmfeathers2;
    public MowzieModelRenderer Lfinger2;
    public MowzieModelRenderer Lfinger1;
    public MowzieModelRenderer Lfinger3;

    public OrnithomimusFemale() {
        this.textureWidth = 256;
        this.textureHeight = 128;
        this.Ltoesole3 = new MowzieModelRenderer(this, 210, 0);
        ...
        this.Rtoemiddle2 = new MowzieModelRenderer(this, 210, 10);
        ...
        this.Rlowerleg = new MowzieModelRenderer(this, 125, 70);
        ...
        this.Llowerarm = new MowzieModelRenderer(this, 195, 85);
        ...
        this.Rupperleg = new MowzieModelRenderer(this, 125, 90);
        ...
        this.Rtoemid1 = new MowzieModelRenderer(this, 210, 10);
        ...
        this.Larmfeather1 = new MowzieModelRenderer(this, 220, 110);
        this.Larmfeather1.setRotationPoint(0.9F, 2.0F, 2.0F);
        this.Larmfeather1.addBox(-1.0F, 0.0F, 0.0F, 1, 9, 4, 0.0F);
        this.Lupperarm = new MowzieModelRenderer(this, 195, 100);
        this.Lupperarm.setRotationPoint(-1.5F, 3.0F, 1.3F);
        this.Lupperarm.addBox(-1.0F, 0.0F, 0.0F, 2, 8, 3, 0.0F);
        this.setRotateAngle(Lupperarm, -0.36425021489121656F, 0.0F, 0.0F);
        this.Ltoetop3 = new MowzieModelRenderer(this, 210, 20);
        ...
        this.Tail2 = new MowzieModelRenderer(this, 5, 45);
        this.Tail2.setRotationPoint(0.0F, 0.3F, 6.0F);
        this.Tail2.addBox(-2.5F, 0.0F, 0.0F, 5, 7, 7, 0.0F);
        this.Lfinger1 = new MowzieModelRenderer(this, 230, 10);
        ...
        this.Tail5 = new MowzieModelRenderer(this, 60, 110);
        ...
        this.Ltoemid3 = new MowzieModelRenderer(this, 210, 10);
        ...
        this.Ltoesole1 = new MowzieModelRenderer(this, 210, 0);
        ...
        this.Snout1 = new MowzieModelRenderer(this, 100, 85);
        this.Snout1.setRotationPoint(0.01F, 1.0F, -2.9F);
        this.Snout1.addBox(-1.5F, 0.0F, -7.0F, 3, 2, 7, 0.0F);
        this.Ltoemid1 = new MowzieModelRenderer(this, 210, 10);
        ...
        this.Rupperarm = new MowzieModelRenderer(this, 175, 100);
        this.Rupperarm.setRotationPoint(1.5F, 3.0F, 1.3F);
        this.Rupperarm.addBox(-1.0F, 0.0F, 0.0F, 2, 8, 3, 0.0F);
        this.setRotateAngle(Rupperarm, -0.36425021489121656F, 0.0F, 0.0F);
        this.Bodyback = new MowzieModelRenderer(this, 5, 80);
        ...
        this.Neck1 = new MowzieModelRenderer(this, 60, 90);
        ...
        this.Lfoot = new MowzieModelRenderer(this, 150, 55);
        ...
        this.Neck3 = new MowzieModelRenderer(this, 60, 60);
        ...
        this.Lhip = new MowzieModelRenderer(this, 150, 110);
        this.Lhip.setRotationPoint(7.0F, -0.8F, 1.0F);
        this.Lhip.addBox(-4.0F, 0.0F, 0.0F, 4, 9, 6, 0.0F);
        this.setRotateAngle(Lhip, -0.4553564018453205F, 0.0F, 0.0F);
        this.Lshoulder = new MowzieModelRenderer(this, 195, 115);
        this.Lshoulder.setRotationPoint(6.5F, 1.0F, -13.0F);
        this.Lshoulder.addBox(-3.0F, 0.0F, 0.0F, 3, 6, 4, 0.0F);
        this.setRotateAngle(Lshoulder, 0.5009094953223726F, 0.0F, 0.0F);
        this.Lfinger3 = new MowzieModelRenderer(this, 230, 30);
        ...
        this.Rtoesole3 = new MowzieModelRenderer(this, 210, 0);
        ...
        this.Ltoesole2 = new MowzieModelRenderer(this, 210, 0);
        this.Ltoesole2.setRotationPoint(0.0F, 2.0F, 1.5F);
        this.Ltoesole2.addBox(-0.5F, 0.0F, -4.0F, 1, 1, 4, 0.0F);
        this.Lupperleg = new MowzieModelRenderer(this, 150, 90);
        ...
        this.Rfinger3 = new MowzieModelRenderer(this, 240, 30);
        ...
        this.Head1 = new MowzieModelRenderer(this, 100, 115);
        ...
        this.Rfinger1 = new MowzieModelRenderer(this, 240, 10);
        ...
        this.Bodyfront = new MowzieModelRenderer(this, 5, 105);
        ...
        this.Rshoulder = new MowzieModelRenderer(this, 175, 115);
        this.Rshoulder.setRotationPoint(-6.5F, 1.0F, -13.0F);
        this.Rshoulder.addBox(0.0F, 0.0F, 0.0F, 3, 6, 4, 0.0F);
        this.setRotateAngle(Rshoulder, 0.5009094953223726F, 0.0F, 0.0F);
        this.Tail1 = new MowzieModelRenderer(this, 5, 60);
        ...
        this.Rfoot = new MowzieModelRenderer(this, 125, 55);
        ...
        this.Snout2 = new MowzieModelRenderer(this, 100, 100);
        ...
        this.RToetop2 = new MowzieModelRenderer(this, 210, 20);
        ...
        this.Rtoetop3 = new MowzieModelRenderer(this, 210, 20);
        ...
        this.Neck4 = new MowzieModelRenderer(this, 60, 45);
        ...
        this.Rfinger2 = new MowzieModelRenderer(this, 240, 20);
        ...
        this.Tail4 = new MowzieModelRenderer(this, 5, 5);
        ...
        this.Tail3 = new MowzieModelRenderer(this, 5, 25);
        ...
        this.Lfinger2 = new MowzieModelRenderer(this, 230, 20);
        ...
        this.Rarmfeather2 = new MowzieModelRenderer(this, 220, 90);
        this.Rarmfeather2.setRotationPoint(-0.9F, -1.0F, 0.0F);
        this.Rarmfeather2.addBox(0.0F, 0.0F, 0.0F, 1, 7, 4, 0.0F);
        this.Lowerjaw = new MowzieModelRenderer(this, 100, 75);
        ...
        this.Rlowerarm = new MowzieModelRenderer(this, 175, 85);
        ...
        this.Neck2 = new MowzieModelRenderer(this, 60, 75);
        ...
        this.Neck5 = new MowzieModelRenderer(this, 60, 35);
        ...
        this.Rtoetop1 = new MowzieModelRenderer(this, 210, 20);
        ...
        this.Llowerleg = new MowzieModelRenderer(this, 150, 70);
        ...
        this.Rtoesole1 = new MowzieModelRenderer(this, 210, 0);
        ...
        this.Rhand = new MowzieModelRenderer(this, 240, 0);
        ...
        this.Ltoetop1 = new MowzieModelRenderer(this, 210, 20);
        ...
        this.Lhand = new MowzieModelRenderer(this, 230, 0);
        ...
        this.Ltoemid2 = new MowzieModelRenderer(this, 210, 10);
