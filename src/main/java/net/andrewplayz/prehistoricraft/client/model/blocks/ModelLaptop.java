...
public class ModelLaptop extends MowzieModelBase {
    public MowzieModelRenderer Laptopbase;
    public MowzieModelRenderer Laptophinge;
    public MowzieModelRenderer Rmousebutton;
    public MowzieModelRenderer Lmousebutton;
    public MowzieModelRenderer Keyboard;
    public MowzieModelRenderer Mousepad;
    public MowzieModelRenderer USB;
    public MowzieModelRenderer Laptoplid;
    public MowzieModelRenderer Laptopscreen;
    public MowzieModelRenderer Antennae;

    public ModelLaptop() {
        this.textureWidth = 128;
        this.textureHeight = 64;
        this.Laptophinge = new MowzieModelRenderer(this, 5, 45);
        this.Laptophinge.setRotationPoint(0.0F, -1.0F, 0.0F);
        this.Laptophinge.addBox(-7.5F, 0.0F, -1.0F, 15, 1, 1, 0.0F);
        this.Antennae = new MowzieModelRenderer(this, 0, 0);
        this.Antennae.setRotationPoint(5.0F, -12.0F, -0.5F);
        this.Antennae.addBox(-0.5F, -3.0F, 0.0F, 1, 3, 0, 0.0F);
        this.Keyboard = new MowzieModelRenderer(this, 5, 5);
        this.Keyboard.setRotationPoint(0.0F, -0.1F, -2.0F);
        this.Keyboard.addBox(-6.5F, 0.0F, -6.0F, 13, 1, 6, 0.0F);
        this.Mousepad = new MowzieModelRenderer(this, 50, 40);
        this.Mousepad.setRotationPoint(0.0F, -0.1F, -8.3F);
        this.Mousepad.addBox(-2.0F, 0.0F, -2.0F, 4, 1, 2, 0.0F);
        this.USB = new MowzieModelRenderer(this, 0, 0);
        this.USB.setRotationPoint(-9.5F, 1.0F, -5.0F);
        this.USB.addBox(0.0F, -0.5F, -1.0F, 3, 1, 2, 0.0F);
        this.Laptoplid = new MowzieModelRenderer(this, 5, 30);
