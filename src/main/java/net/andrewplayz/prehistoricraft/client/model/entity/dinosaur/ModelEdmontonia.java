...
public class ModelEdmontonia extends AdvancedModelBase {
    ...
    public ModelEdmontonia() {
        ...
        this.Rshoulder.setRotationPoint(-10.0F, 5.6F, 2.0F);
        this.Rshoulder.addBox(0.0F, 0.0F, 0.0F, 6, 11, 7, 0.0F);
        this.setRotateAngle(Rshoulder, 0.22759093446006054F, 0.0F, 0.136659280431156F);
        ...
        this.Tail1.setRotationPoint(0.0F, 0.3F, 15.0F);
        ...
        this.Lhip.setRotationPoint(9.0F, 2.0F, 8.0F);
        this.Lhip.addBox(-6.0F, 0.0F, 0.0F, 6, 12, 7, 0.0F);
        this.setRotateAngle(Lhip, -0.18203784098300857F, 0.0F, -0.18203784098300857F);
        ...
        this.Rhip.setRotationPoint(-9.0F, 2.0F, 8.0F);
        this.Rhip.addBox(0.0F, 0.0F, 0.0F, 6, 12, 7, 0.0F);
        this.setRotateAngle(Rhip, -0.18203784098300857F, 0.0F, 0.18203784098300857F);
        ...
        this.Lshoulder.setRotationPoint(10.0F, 5.6F, 2.0F);
        this.Lshoulder.addBox(-6.0F, 0.0F, 0.0F, 6, 11, 7, 0.0F);
        this.setRotateAngle(Lshoulder, 0.22759093446006054F, 0.0F, -0.136659280431156F);
        ...
        this.Tail3.setRotationPoint(0.0F, 0.3F, 10.6F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float rotation, float rotationYaw, float rotationPitch, float partialTicks, Entity entity) {
        ...
        walk(LFleg, 0.3F * globalSpeed, 0.4F * globalHeight, false, 0.5F, 0.0F, limbSwing, limbSwingAmount);
        ...
        walk(RFleg, 0.3F * globalSpeed, 0.4F * globalHeight, true, 0.5F, 0.0F, limbSwing, limbSwingAmount);
        walk(RFfoot, 0.3F * globalSpeed, 0.4F * globalHeight, true, -1.5F, -0.5F, limbSwing, limbSwingAmount);

        //Back Left Leg
        walk(Lhip, 0.3F * globalSpeed, 0.4F * globalHeight, false, -1.0F, 0.2F, limbSwing, limbSwingAmount);
        walk(LBleg, 0.3F * globalSpeed, 0.4F * globalHeight, false, -1.5F, 0.2F, limbSwing, limbSwingAmount);
        walk(LBfoot, 0.3F * globalSpeed, 0.4F * globalHeight, false, -1.5F, 0.8F, limbSwing, limbSwingAmount);

        //Back Right Leg
        walk(Rhip, 0.3F * globalSpeed, 0.4F * globalHeight, true, -1.0F, 0.2F, limbSwing, limbSwingAmount);
        walk(RBleg, 0.3F * globalSpeed, 0.4F * globalHeight, true, -1.5F, -0.5F, limbSwing, limbSwingAmount);
        walk(RBfoot, 0.3F * globalSpeed, 0.4F * globalHeight, true, -1.5F, -0.5F, limbSwing, limbSwingAmount);
