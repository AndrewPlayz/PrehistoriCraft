...
public class ClientProxy extends ServerProxy {
    ...
    public void onPreInit() {
        //Mobs [HorseShoe]
        RenderingRegistry.registerEntityRenderingHandler(EntityOrnithomimus.class, new PrehistoricRenderFactory<EntityOrnithomimus>(new ModelOrnithomimus(), "ornithomimusmale.png", "ornithomimusfemale.png", 0.8F, 1.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityAnodontosaurus.class, new PrehistoricRenderFactory<EntityAnodontosaurus>(new ModelAnodontosaurus(), "anodontosaurusmale.png", "anodontosaurusfemale.png", 1.4F, 1.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityDaspletosaurus.class, new PrehistoricRenderFactory<EntityDaspletosaurus>(new ModelDaspletosaurus(), "daspletosaurusmale.png", "daspletosaurusfemale.png", 1.4F, 1.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityEdmontonia.class, new PrehistoricRenderFactory<EntityEdmontonia>(new ModelEdmontonia(), "edmontoniamale.png", "edmontoniafemale.png", 1.6F, 1.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityHypacrosaurus.class, new PrehistoricRenderFactory<EntityHypacrosaurus>(new ModelHypacrosaurus(), "hypacrosaurusmale.png", "hypacrosaurusfemale.png", 2.0F, 1.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityPachyrhinosaurusCanadensis.class, new PrehistoricRenderFactory<EntityPachyrhinosaurusCanadensis>(new ModelPachyrhinosaurusCanadensis(), "pachyrhinosauruscanadensismale.png", "pachyrhinosauruscanadensisfemale.png", 1.5F, 1.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityPachyrhinosaurusLakustai.class, new PrehistoricRenderFactory<EntityPachyrhinosaurusLakustai>(new ModelPachyrhinosaurusLakustai(), "pachyrhinosauruslakustaimale.png", "pachyrhinosauruslakustaifemale.png", 1.5F, 1.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityTroodon.class, new PrehistoricRenderFactory<EntityTroodon>(new ModelTroodon(), "troodonmale.png", "troodonfemale.png", 0.9F, 1.5F));
    }
